 ...
 * @returns void
 */
setInterval(function() { mainbody();}, 1000);
  ...
  for (i = 0; i < 5; i++) {
    ...
    switch(i) {
      case 0:
        ...
        inputEle.onclick = function(){storeTimer(0);};
        labelEle.for = "never";
      ...
      case 1:
        ...
        inputEle.onclick = function(){storeTimer(30);};
        labelEle.for = "30";
      ...
      case 2:
        ...
        inputEle.onclick = function(){storeTimer(120);};
        labelEle.for = "120";
        ...
        case 3:
          ...
          inputEle.onclick = function(){storeTimer(300);};
          labelEle.for = "300";
        ...
        case 4:
          ...
          inputEle.onclick = function(){storeTimer(1500);};
          labelEle.for = "1500";
...
function mainbody() {
  ...
  timerConsoleView(qTimer, secondCounter);
}
 ...
 * @returns void
 */
function timerConsoleView(qTimer, secondCounter){
